...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, default="models/", help="path for saving trained models"
    )
    parser.add_argument(
        "--crop_size", type=int, default=224, help="size for randomly cropping images"
    )
    parser.add_argument(
        "--vocab_path", type=str, default="data/vocab.pkl", help="path for vocabulary wrapper"
    )
    parser.add_argument(
        "--image_dir", type=str, default="data/resized2014", help="directory for resized images"
    )
    parser.add_argument(
        "--caption_path",
        type=str,
    ...
    parser.add_argument(
        "--save_step", type=int, default=1000, help="step size for saving trained models"
    )
